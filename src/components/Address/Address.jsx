        ...
        <section id="address">
            <div className="address py-[10px] !bg-cover rounded-lg grayscale-[0%] bg-center !bg-fixed ">
                ...
                <div className=" container w-1/2 flex justify-center mx-auto gap-x-0 flex-wrap md:flex-nowrap " >
                    ...
                    <a href="mailto:info@ikorc.ir" rel="noreferrer" target="_blank" className="w-20 md:w-[100px] px-5 py-2 text-center mx-auto flex justify-center border border-cyan-50/5 hover:border hover:border-yellow-500 hover:scale-110 bg-slate-950/90 hover:bg-black/60 rounded-2xl cursor-pointer transition-all duration-300">
                        <SiGmail className="fill-red-500   text-4xl md:text-7xl text-center" />
                    </a>
                    <a href="https://instagram.com/hosein_mohammadshahi?igshid=NGVhN2U2NjQ0Yg==" rel="noreferrer" target="_blank" className="w-20 md:w-[100px] px-5 py-2 text-center mx-auto flex justify-center border border-cyan-50/5 hover:border hover:border-yellow-500 hover:scale-110 bg-slate-950/90 hover:bg-black/60 rounded-2xl cursor-pointer transition-all duration-300">
                        <FaInstagram className="fill-red-500  text-4xl md:text-7xl text-center" />
                    </a>
                    <a href="https://t.me/ikorc1" rel="noreferrer" target="_blank" className="w-20 md:w-[100px] px-5 py-2 text-center mx-auto flex justify-center border border-cyan-50/5 hover:border hover:border-yellow-500 hover:scale-110 bg-slate-950/90 hover:bg-black/60 rounded-2xl cursor-pointer transition-all duration-300">
