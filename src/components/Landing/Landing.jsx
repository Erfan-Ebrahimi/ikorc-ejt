                ...
                <div className="w-full h-[100%] md:h-[400px]   flex flex-col justify-center items-center pt-10 text-center">
                    <div className=" w-full">
                        ...
                        <div className="flex justify-center items-center gap-x-4 py-5 md:bg-slate-950/50">
                            <a href="/" className="w-[100px] md:w-[120px] bg-red-100 text-rose-700 py-1 md:py-1.5 text-sm md:text-base md:px-1 font-DanaB rounded-xl hover:text-white hover:bg-rose-700 transition-all duration-300">ورود | ثبت نام</a>
                            <span className="text-white text-xl">|</span>
                            <a href="/" className="w-[100px] md:w-[120px] bg-rose-700 text-white py-1 md:py-1.5 text-sm md:text-base md:px-1 font-DanaB rounded-xl hover:text-rose-800 hover:bg-white transition-all duration-300">ارتباط با ما</a>
                        </div>
                    </div>
                </div>
