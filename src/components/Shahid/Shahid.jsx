...
const Shahid = () => {
    return (
        <div className="container mt-24 my-40" >
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-y-5 md:gap-x-10 mt-10">

                <div className="md:w-1/2 flex flex-col md:flex-row items-center justify-center gap-x-1">
                    <div className="w-[200px] md:w-[300px]">
                        <img src="./assets/images/sh1.png" alt="" />
                    </div>
                    <div className="md:w-1/2  flex flex-col justify-between">
                        <h1 className="font-Dana  md:font-Nast text-xl md:text-4xl text-yellow-300/80 text-center">غلام علی سلیمانی</h1>
                        <div className="font-Dana text-white mt-2 flex justify-center md:justify-evenly">
                ...
                <div className="md:w-1/2 flex flex-col md:flex-row items-center justify-center gap-x-1">
                    ...
                    <div className="md:w-1/2  flex flex-col justify-between">
                        <h1 className="font-Dana  md:font-Nast text-xl md:text-4xl text-yellow-300/80 text-center">محمد رایگان</h1>
                        <div className="font-Dana text-white mt-2 flex justify-center md:justify-evenly">
                            <span className="text-green-500"> ولادت  </span>
