...
const Actions = () => {
  return (
    <section className="my-14">
      <h2 className="title-header w-1/4 mx-auto mb-5 pb-5 text-4xl text-center text-transparent  bg-clip-text bg-gradient-to-t from-rose-400 to-sky-600 font-MorabbaB">فعالیت های اخیر</h2>
      <div className="flex flex-wrap mx-auto w-full justify-center mt-10 gap-10">
