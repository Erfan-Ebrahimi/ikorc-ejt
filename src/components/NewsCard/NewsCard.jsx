...
const NewsCard = ({ img, title, desc, date, author }) => {
  return (
    <div className="flex flex-col w-[380px] bg-zinc-800 rounded-2xl overflow-hidden cursor-pointer hover:scale-90 hover:bg-zinc-600 duration-300">
      ...
      <div className="mt-2 text-white">
        ...
        <h5 className="font-DanaM text-xs text-right px-2.5 mt-3 tracking-wider line-clamp-2 text-yellow-200">{desc}</h5>
        <Link to='/' className="block text-center text-zinc-100 font-MorabbaM mt-5 px-1 py-0.5 rounded-md bg-teal-800">ادامه . . .</Link>
