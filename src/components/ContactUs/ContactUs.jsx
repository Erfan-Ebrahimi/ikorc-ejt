        ...
        <>
            ...
            <section id="contact" className="h-[400px] flex justify-center items-center mb-[60px] p-5 bg-cover overflow-hidden relative !bg-fixed grayscale-[70%]">
                ...
                <div className="container flex justify-between" >
                    ...
                    <a className="w-[220px] p-5 border border-cyan-50/5 hover:border hover:border-yellow-500 hover:scale-110 bg-black/40 hover:bg-black/60 rounded-2xl cursor-pointer transition-all duration-300">
                    ...
                    <a href="https://www.ikorc.ir" className="w-[220px] p-5 border border-cyan-50/5 hover:border hover:border-yellow-500 hover:scale-110 bg-black/40 hover:bg-black/60 rounded-2xl cursor-pointer transition-all duration-300">
                        <div className="flex flex-col justify-between items-center text-center">
